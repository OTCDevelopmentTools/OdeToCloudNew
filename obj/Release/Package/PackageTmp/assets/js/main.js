...
(function() {
 ...
 carousels.forEach(carousel => {
     // Select elements inside each carousel
     ...
     let unAcceppClick; // Prevents rapid clicking
     ...
     // Event listeners for "See More" buttons inside each carousel
     ...
     // Event listener for "Back" button inside each carousel
     backButton.onclick = () => {
